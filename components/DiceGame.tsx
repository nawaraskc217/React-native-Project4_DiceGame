...
export default function DiceGame() {
  const [diceNumber, setDiceNumber] = useState<ImageSourcePropType>(DiceFive)

  const randomNumber = () => {
    const randomNoForStat = Math.floor(Math.random() * 6) + 1

    switch (randomNoForStat) {
      case 1:
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.button} onPress={randomNumber}>
